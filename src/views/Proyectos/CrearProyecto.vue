...
function buildPayload(
  ...
  return {
    ...
    num_tickets: typeof data.num_tickets === 'number' && Number.isFinite(data.num_tickets) ? data.num_tickets : null,
    precio_unidad: Number(data.precio_unidad) || 0,
    tir_preferente: data.tir_preferente != null ? Number(data.tir_preferente) : null,
